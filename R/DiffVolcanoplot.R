...
#'
#' Draw a volcano plot of features in transition defined ST data
#'
#' @param DiffGenes A list of data frame contain differential expressed genes and its p value, log2FC and adjusted p value in tumor, transition zone and out spots
#' @param Location Name in transition defined ST data ("Tumor","Trans","OutSpots")
